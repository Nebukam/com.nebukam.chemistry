...
namespace Nebukam.Chemistry
{
    ...
    public class LowestAnthropySolverBehaviour3D : ModuleTesterBehaviour<SlotClusterFixed<ConstrainedSlot, ClusterBrain>, ConstrainedSlot, ConstrainedSlotInfos, ClusterBrain>
    {
