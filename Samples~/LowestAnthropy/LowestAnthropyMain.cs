...
namespace Nebukam.Chemistry
{
    ...
    public class LowestAnthropyMain : SlotGrid
    {

        public AtomConstraintsManifest manifest;
        public ISlotCluster<ConstrainedSlot, ClusterBrain> cluster;
        public LowestAntropySolver<ConstrainedSlot, ConstrainedSlotInfos, ClusterBrain> solver;
        ...
        void Start()
        {
            ...
            solver = new LowestAntropySolver<ConstrainedSlot, ConstrainedSlotInfos, ClusterBrain>();
