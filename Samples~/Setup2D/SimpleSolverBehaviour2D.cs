...
namespace Nebukam.Chemistry
{
    ...
    public class SimpleSolverBehaviour2D : ModuleTesterBehaviour<SlotClusterFixed<ConstrainedSlot, ClusterBrain>, ConstrainedSlot, ConstrainedSlotInfos, ClusterBrain>
    {
