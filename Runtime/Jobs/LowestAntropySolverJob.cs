...
namespace Nebukam.Chemistry
{
        ...
        where T_BRAIN : struct, IClusterBrain
    {
        ...
        public void Execute()
        {
            ...
            NativeList<int> candidates = new NativeList<int>(nCount, Allocator.Temp);
            ...
            NativeArray<NativeList<int>> anthropy = new NativeArray<NativeList<int>>(nCount, Allocator.Temp);
            NativeList<int> subList;
            for (int i = 0; i < nCount; i++)
            {
                subList = anthropy[i];
                //TODO : Check if need to create new lists of if instanciation by nativeArray is enough (likely not)
            }
