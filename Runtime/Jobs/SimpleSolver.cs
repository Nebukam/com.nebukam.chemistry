...
namespace Nebukam.Chemistry
{
    ...
    public class SimpleSolver<T_SLOT, T_SLOT_INFOS, T_BRAIN> : AbstractSolverBundle<T_SLOT, T_SLOT_INFOS, SimpleConstraintsSolverJob<T_SLOT, T_SLOT_INFOS, T_BRAIN>, T_BRAIN, SimpleConstraintsSolverProcessor<T_SLOT, T_SLOT_INFOS, T_BRAIN>>
